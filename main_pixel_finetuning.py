...
def main():
    ...
    parser.add_argument("--dump_path", type=str, default='./final_finetune', help="The path to save results.")
    parser.add_argument("--dump_checkpoints", type=str, default='./final_finetune')
    ...
    parser.add_argument("--pretrained", type=str, default="/home/zixuanqian/tmp/origin/vit_pass2/checkpoint.pth.tar", help="The model checkpoint file.")
    ...
    parser.add_argument('--pseudo_path', default='./vit_pass4/pixel_attention/train')
    parser.add_argument('--finetune_scale_factor', default=1)
