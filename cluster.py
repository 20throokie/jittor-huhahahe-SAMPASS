...
parser.add_argument("-s", "--seed", default=31, type=int, help="the seed for clustering")
parser.add_argument("--pretrained", type=str, default="/home/zixuanqian/tmp/origin/vit_pass9/pixel_attention/checkpoint.pth.tar", help="the model checkpoint")
parser.add_argument("--data_path", type=str, default="/home/zixuanqian/tmp/ImageNetS50/ImageNetS50/", help="path to data")
